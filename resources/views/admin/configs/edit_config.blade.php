    ...
    <div class="card-body">
        <form method="POST" action="{{ url('admin/edit-config/'.$config->id) }}">
            ...
            <div class="form-group">
              <label for="config_name">Name Config</label>
            <input type="text" class="form-control" id="config_name" value="{{ $config->config_name }}" name="config_name" placeholder="Tên Cấu Hình" required>
